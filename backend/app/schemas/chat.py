...
class ChatResponse(BaseModel):
    ...
    thinking_process: Optional[str] = Field(
        default=None,
        description="Transparent chain-of-thought analysis and compliance reasoning generated by Gemini",
    )
...
class GeminiAnswerPayload(BaseModel):
    ...
    thinking_process: Optional[str] = Field(default=None, description="Step-by-step reasoning or thought process")
